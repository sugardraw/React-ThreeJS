...
export default class Canvas extends Component {
  ...
  selectGeo = e => {
    ...
    switch (e.target.value) {
      case "Ball":
        const geo0 = new THREE.SphereGeometry(40, 40, 40);
      ...
      case "Box":
        ...
        break;
      case "Cylinder":
        const geo2 = new THREE.CylinderGeometry(35, 35, 25, 25);
        threeEntryPoint(this.threeRootElement, geo2);

        break;
      case "Torus":
        const geo3 = new THREE.TorusGeometry(25, 25);
  ...
  render() {
    return (
      ...
      >
        <div style={{color:'white', marginTop:"200px", marginLeft:"150px", maxWidth:"200px"}} className="col-4  position-absolute">
          <label style={{color:'white'}} htmlFor="geo">Select a Geometry</label>
          <select
